...
# Load data
filename = '200619_cvx_result_grouplasso_L=5.mat'
...
x = data['x']
x_reshaped = np.reshape(x,(512,360),order='F')
x_averaged = np.mean(x_reshaped,axis=0)
x_normalized = x_averaged/(max(x_averaged))
