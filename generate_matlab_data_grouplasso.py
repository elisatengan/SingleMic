...
print("Hello generate_matlab_data_grouplasso.py")
...
y_train = np.sum(y_psd_hat,axis=0)

io.savemat("200619_data_grouplasso_L=%s.mat" % nb_sources, dict([("A", big_matrix_A), ("b", y_train)]))
