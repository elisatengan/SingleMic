...
h1, = plt.plot(taxis, psds1_welch[selectfrequency, :], label='PSD s1')
h2, = plt.plot(taxis, psds2_welch[selectfrequency, :], label='PSD s2')
h3, = plt.plot(taxis, psdsy_welch[selectfrequency, :], label='PSD s3')
h4, = plt.plot(taxis, psds1_welch[selectfrequency, :] + psds2_welch[selectfrequency, :], label='PSD s1 + PSD s2')
plt.legend()
...
h1, = plt.plot(taxis,psds1_exp[selectfrequency, :], label='PSD s1 exp')
h2, = plt.plot(taxis,psds1_welch[selectfrequency, :], label='PSD s1 welch')
